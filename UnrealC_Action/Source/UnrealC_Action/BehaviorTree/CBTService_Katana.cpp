...
UCBTService_Katana::UCBTService_Katana()
{
	NodeName = "Katana";
}

void UCBTService_Katana::TickNode(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
